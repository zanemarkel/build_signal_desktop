...
install:
	...
	@sudo sed -i 's|Exec=/opt/Signal/signal-desktop.*|Exec=/opt/Signal/signal-desktop --enable-features=UseOzonePlatform --ozone-platform=wayland --use-tray-icon %U|g' /usr/share/applications/signal-desktop.desktop
